...
class Attention_v1(nn.Module):
    ...
    def __init__(self, args: ModelArgs_v1):
        super().__init__()
...
class Attention_v2(nn.Module):
    def __init__(self, args: ModelArgs_v2):
        """
...
class TransformerBlock_v1(nn.Module):
    def __init__(self, layer_id: int, args: ModelArgs_v1):
        super().__init__()
...
class TransformerBlock_v2(nn.Module):
    def __init__(self, layer_id: int, args: ModelArgs_v2):
        """
        ...
        self.dim = args.dim
        self.head_dim = args.dim // args.n_heads
        self.attention = Attention_v2(args)
        self.feed_forward = FeedForward(
            dim=args.dim,
...
class Transformer(nn.Module):
    def __init__(self, params: Union[ModelArgs_v1, ModelArgs_v2]):
        """
        ...
        if isinstance(params, ModelArgs_v1):
            ...
            TransformerBlock = TransformerBlock_v2
